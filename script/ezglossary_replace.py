...
TERMS = [
    ...
    (r'\bWallet Unit Attestations\b',
     '<artifacts:Wallet Unit Attestation (WUA)|Wallet Unit Attestations>',
     r'<artifacts:Wallet Unit Attestation (WUA)\|Wallet Unit Attestations>'),
    (r'\bWallet Unit Attestation\b',
     '<artifacts:Wallet Unit Attestation (WUA)|Wallet Unit Attestation>',
     r'<artifacts:Wallet Unit Attestation (WUA)\|Wallet Unit Attestation>'),
    (r'\bWallet Instance Attestations\b',
     '<artifacts:Wallet Instance Attestation (WIA)|Wallet Instance Attestations>',
     r'<artifacts:Wallet Instance Attestation (WIA)\|Wallet Instance Attestations>'),
    (r'\bWallet Instance Attestation\b',
     '<artifacts:Wallet Instance Attestation (WIA)|Wallet Instance Attestation>',
     r'<artifacts:Wallet Instance Attestation (WIA)\|Wallet Instance Attestation>'),
    ...
    (r'\bRelying Party Backends\b',
     '<components:Verifier Backend|Relying Party Backends>',
     r'<components:Verifier Backend\|Relying Party Backends>'),
    (r'\bRelying Party Backend\b',
     '<components:Verifier Backend|Relying Party Backend>',
     r'<components:Verifier Backend\|Relying Party Backend>'),
    ...
    (r'\bRequest Objects\b',
     '<artifacts:Request Object|Request Objects>',
     r'<artifacts:Request Object\|Request Objects>'),
    (r'\bRequest Object\b',
    ...
    (r'\bPKCE\b',
     ...
     '<protocols:PKCE>'),
    (r'\bWUAs?\b',
     '<artifacts:Wallet Unit Attestation (WUA)|WUA>',
     r'<artifacts:Wallet Unit Attestation (WUA)\|WUA>'),
    (r'\bWIAs?\b',
     '<artifacts:Wallet Instance Attestation (WIA)|WIA>',
     r'<artifacts:Wallet Instance Attestation (WIA)\|WIA>'),

    # Nonce — only standalone, not inside c_nonce or identifiers
    (r'\bNonces\b',
     '<data-elements:Nonce|Nonces>',
     r'<data-elements:Nonce\|Nonces>'),
    (r'(?<![_`])\bNonce\b(?![_`])',
     '<data-elements:Nonce>',
     '<data-elements:Nonce>'),
    (r'\bnonces\b',
