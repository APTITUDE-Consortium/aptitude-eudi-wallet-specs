...
2. For **same-device**, implementations **SHALL** support at least the custom URL scheme `openid-credential-offer://`.
3. For **cross-device**, implementations **SHALL** support delivery through a QR code carrying a valid Credential Offer URI
