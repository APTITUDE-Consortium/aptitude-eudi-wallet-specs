...
The mandatory interoperability baseline defined by this RFC is:

**QR Code Device Engagement → BLE Device Retrieval**
...
The mandatory APTITUDE interoperability baseline is:
...
2. ETSI TS 119 472-2 V1.3.1 (2026-07), *Electronic Signatures and Trust Infrastructures (ESI); Profiles for Electronic Attestation of Attributes; Part 2: Profiles for EAA/PID Presentations to Relying Party*
